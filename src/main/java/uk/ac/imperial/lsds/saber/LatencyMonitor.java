...
public class LatencyMonitor {
	...
	public void monitor (IQueryBuffer buffer, int mark) {
        ...
        long t1 = (long) (buffer.getLong(mark));
		long t2 = (System.nanoTime() - timestampReference) / 1000_000L;
        // dt = (t2 - t1) / 1000.; /* In milliseconds */
        // System.out.println("System.nanoTime: " + System.nanoTime() + ", timestampReference: " + timestampReference);

        dt = (t2 - t1);
        // System.out.println("mark: " + mark + ", buffer.getLong(mark): " + buffer.getLong(mark) + ", t1: " + t1 + ", t2: " + t2 + ", dt: " + dt);
		measurements.add(dt);
