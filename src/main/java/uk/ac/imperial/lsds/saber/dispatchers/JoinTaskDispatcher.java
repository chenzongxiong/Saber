...
public class JoinTaskDispatcher implements ITaskDispatcher {
    ...
    public JoinTaskDispatcher (Query query) {
		...
		firstBuffer  = new CircularQueryBuffer(parent.getId(), SystemConf.CIRCULAR_BUFFER_SIZE, false, parent.getPapiSamplers());
		secondBuffer = new CircularQueryBuffer(parent.getId(), SystemConf.CIRCULAR_BUFFER_SIZE, false, parent.getPapiSamplers());
