...
public class TaskProcessor implements Runnable {
    ...
    PAPIHardwareSampler hwPAPI;
	public TaskProcessor (int pid, TaskQueue queue, int [][] policy, boolean GPU, boolean hybrid) {
        this(pid, queue, policy, GPU, hybrid, null);
	}

	public TaskProcessor (int pid, TaskQueue queue, int [][] policy, boolean GPU, boolean hybrid, PAPIHardwareSampler hwPAPI) {
	...
	public void run () {
        ...
        try {
            if (this.hwPAPI != null) {
                System.out.println("PAPI starts to sample");
            ...
            System.out.println("PAPI exeception....");
            ex.printStackTrace();
        }
	}
