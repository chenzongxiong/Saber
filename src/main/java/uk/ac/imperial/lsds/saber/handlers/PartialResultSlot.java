...
public class PartialResultSlot {
	...
	public void aggregateSingleKey (PartialResultSlot p, IAggregateOperator operator) {
        ...
        System.out.println("[DBG] numberOfWindows: " + p.closingWindows.numberOfWindows() + ", closingWindows.buffer.b2: " + b2);
...
/*		System.out.println("w3 hashtable");
	...
	public String toString () {
        ...
        s.append(String.format(", closingWindows: %s", closingWindows.toString()));
        s.append(String.format(", completeWindows: %s", completeWindows.toString()));
        s.append(String.format(", pendingWindows: %s", pendingWindows.toString()));
        s.append(String.format(", openingWindows: %s", openingWindows.toString()));
